...
def description_comp(den: Denario) -> None:
    ...
    uploaded_file = st.file_uploader("Alternatively, upload a markdown file with the data description.", accept_multiple_files=False, type=["md", "txt"])
...
def idea_comp(den: Denario) -> None:
    ...
    uploaded_file = st.file_uploader("Choose a markdown file with the research idea", accept_multiple_files=False, type=["md", "txt"])
...
def method_comp(den: Denario) -> None:
    ...
    uploaded_file = st.file_uploader("Choose a markdown file with the research methods", accept_multiple_files=False, type=["md", "txt"])
